...
const uri = `mongodb+srv://${process.env.SECRET_USERNAME}:${process.env.SECRET_PASS}@cluster0.7e1v4.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
    ...
    try {
        ...
        const inventoryCollection = client.db('motoUser').collection("motoBike");
